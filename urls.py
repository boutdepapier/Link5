...
urlpatterns = patterns('',
    ...
    url(r'^day/$', 'link5app.views.home', name='link_day'),
    url(r'^day/(?P<page>\d+)/$', 'link5app.views.home', name='Link_day_nav'),
    
    url(r'^week/$', 'link5app.views.home', name='link_week'),
    url(r'^week/(?P<page>\d+)/$', 'link5app.views.home', name='link_week_nav'),
    
    url(r'^month/$', 'link5app.views.home', name='link_month'),
    url(r'^month/(?P<page>\d+)/$', 'link5app.views.home', name='link_month_nav'),
